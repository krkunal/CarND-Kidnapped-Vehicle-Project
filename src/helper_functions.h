...
/**
 * Computes the Multi variate Gaussian Probability density.
 * @param (sig_x,sig_y) x and y Landmark measurement uncertainties
 * @param (x_obs,y_obs) x and y coordinates of the observation in map coordinate
 * @param (mu_x,mu_y) x and y coordinates of the associated landmark
 * @output Probability density for the measurement
 */
